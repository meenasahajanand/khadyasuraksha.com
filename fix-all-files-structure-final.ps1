# PowerShell Script to Add Missing Carousel and Get the Game Sections to ALL Files
# Fix structure: ad_box closing > carousel > Get the Game > Description
...
foreach ($file in $gameFiles) {
    ...
    try {
        ...
        if (-not $hasCarousel -or -not $hasGetGame) {
            ...
            # Pattern: </script> </div> </div> </div> <div class="public_box"> <div class="box_three"> <h3>Description</h3>
            # Need to insert carousel and Get the Game before Description
            
            if ($content -match '(?s)(</script>\s*</div>\s*</div>\s*</div>\s*<div class="public_box">\s*<div class="box_three">\s*<h3>Description</h3>)') {
                $replacement = ""
...
"@
                    ...
                    Write-Host "  Adding carousel" -ForegroundColor Yellow
                }
...
"@
                        Write-Host "  Adding Get the Game section" -ForegroundColor Yellow
                    }
                }
                
                if ($replacement) {
                    $content = $content -replace '(?s)(</script>\s*</div>\s*</div>\s*</div>\s*<div class="public_box">\s*<div class="box_three">\s*<h3>Description</h3>)', "$replacement`n            <div class=`"public_box`">`n                <div class=`"box_three`">`n                    <h3>Description</h3>"
                    $changed = $true
                }
            } elseif ($content -match '(?s)(</script>\s*</div>\s*</div>\s*</div>\s*</div>\s*<div class="public_box">\s*<div class="box_three">\s*<h3>Description</h3>)') {
                # Alternative pattern with extra closing div
                $replacement = ""
